...
const PoliticalCalendar: React.FC<PoliticalCalendarProps> = ({ 
  ...
  const electoralDeadlines: ElectoralDeadline[] = [
    // Eleições 2024
    {
      ...
      date: '2024-07-20',
      type: 'convention',
      description: 'Início do período para realização de convenções partidárias',
      mandatory: true,
      daysNotice: 30
    },
    {
      ...
      date: '2024-08-15',
      type: 'registration',
      description: 'Último dia para registro de candidaturas no TSE',
      mandatory: true,
      daysNotice: 15
    },
    {
      ...
      date: '2024-08-16',
      type: 'campaign_start',
      description: 'Início oficial do período de campanha eleitoral',
      mandatory: true,
      daysNotice: 7
    },
    {
      id: 'elec2024',
      title: 'Eleições Municipais - 1º Turno',
      date: '2024-10-06',
      type: 'election',
      description: 'Dia das eleições municipais - 1º turno',
      mandatory: true,
      daysNotice: 30
    },
    {
      id: 'elec2024-2',
      title: 'Eleições Municipais - 2º Turno',
      date: '2024-10-27',
      type: 'election',
      description: 'Dia das eleições municipais - 2º turno (se houver)',
      mandatory: false,
      daysNotice: 14
    },
    // Janelas partidárias 2025
    {
      id: 'window2025-open',
      title: 'Abertura da Janela Partidária',
      date: '2025-03-01',
      type: 'window_open',
      description: 'Início do período para mudança de partido sem perda de mandato',
      mandatory: false,
      daysNotice: 30
    },
    {
      ...
      date: '2025-04-01',
      type: 'window_close',
      description: 'Último dia para mudança de partido',
      mandatory: false,
      daysNotice: 7
    }
  ];
...
// Adicione também os imports necessários
